...
<Step className="text-sm">Copy and paste the following code into your project.</Step>
...
<Step className="text-sm">Update the import paths to match your project setup.</Step>
